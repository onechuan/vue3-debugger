...
/**
 * @description 判断当前vue版本是否为vue3
 * @param {*} root 
 * @returns 是vue3版本返回 插件vue/compiler-sfc
 */
...
async function transformMain(code, filename, options, pluginContext, ssr, customElement) {
  ...
  //   调用createDescriptor函数创建一个descriptor对象
...
function vuePlugin(rawOptions = {}) {
  ...
  return {
    ...
    /**
     * @description buildStart 是一个生命周期钩子函数
     */
    buildStart() {
    ...
    /**
     * @description transform 是一个生命周期钩子函数
     * @param {*} code 
     * @param {*} id 
     * @param {*} opt 
     * @returns 
